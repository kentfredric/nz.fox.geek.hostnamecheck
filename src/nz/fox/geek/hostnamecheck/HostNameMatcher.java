...
public final class HostNameMatcher {
	...
	private static final List<String> whitelist = Arrays.asList("nz.noirland.co.nz","au.noirland.co.nz","us.noirland.co.nz");
	...
	public final HostNameInfo match(final String hostname) {
		return new HostNameInfo(hostname, 
				this.isBadServer(hostname),
				this.isGoodServer(hostname),
